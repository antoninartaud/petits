          ...
          <div className='offset-2 py-4'>
            <div id='jeu'>
              <div className='grid-game'>
                ...
                <div className='flex'>{this.renderCircles(2, 9)}</div>
                ...
                <div className='flex grid-item-5'>
                  <div className='containerP1'>
                    <div className='divchildP1'>
                      <div>
                        <Circle
                          circleColor={
                            this.state.player1Tokens[0] ? '#4646e8' : 'black'
                          }
                        />

                        <Circle
                          circleColor={
                            this.state.player1Tokens[1] ? '#4646e8' : 'black'
                          }
                        />
                      </div>
                      ...
                      <div>
                        <Circle
                          circleColor={
                            this.state.player1Tokens[2] ? '#4646e8' : 'black'
                          }
                        />

                        <Circle
                          circleColor={
                            this.state.player1Tokens[3] ? '#4646e8' : 'black'
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className='containerP2'>
                    <div className='divchildP2'>
                      <div>
                        <Circle
                          circleColor={
                            this.state.player2Tokens[0] ? '#c30c0c' : 'black'
                          }
                        />
                        <Circle
                          circleColor={
                            this.state.player2Tokens[1] ? '#c30c0c' : 'black'
                          }
                        />
                      </div>
                      ...
                      <div>
                        <Circle
                          circleColor={
                            this.state.player2Tokens[2] ? '#c30c0c' : 'black'
                          }
                        />
                        <Circle
                          circleColor={
                            this.state.player2Tokens[3] ? '#c30c0c' : 'black'
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className='numeroDee'>
                    ...
                    <button
                      className={this.state.currentPlayer === 1 ? 'b1' : 'b2'}
                      onClick={this.lancerDee}
                    >
                      Lancer dé du joueur {this.state.currentPlayer}
                    </button>
                  </div>
                </div>
